...
int ft4_encode(char *message, float *signal, int num_samples, float frequency, int sample_rate) { return ftX_encode(message, signal, num_samples, frequency, sample_rate, true); }

// generate FT8 signal for message
int ft8_encode(char *message, float *signal, int num_samples, float frequency, int sample_rate) { return ftX_encode(message, signal, num_samples, frequency, sample_rate, false); }
